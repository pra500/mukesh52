...
public class Utility {
	...
	public static void captureScreenshot(WebDriver driver)
	{
		...
		try 
		{
			FileHandler.copy(((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE), new File("C:\\Users\\Admin\\eclipse-workspace\\Mukesh\\Screenshots\\screenshot"+getCurrentDate()+".png"));
